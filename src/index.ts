...
import type { Params, UserData, AppEventsFlushBehavior } from './types';

export { AppEvents, AppEventParams } from './types';
export type { Params, UserData, AppEventsFlushBehavior } from './types';

const NativeFBAnalytics =
  NitroModules.createHybridObject<FacebookAnalyticsSpec>('FacebookAnalytics');

/**
 * Facebook App Events Logger - analytics only.
 *
 * Provides methods for logging events, purchases, and managing user identity
 * for Facebook Analytics via the Facebook SDK Core module.
 */
