...
The package exports two constant objects so you don't have to remember Facebook's
raw event and parameter strings.
...
```typescript
import { AppEvents, AppEventParams } from "expo-facebook-analytics";

logEvent(AppEvents.AddedToCart, {
  [AppEventParams.ContentID]: "sku-42",
